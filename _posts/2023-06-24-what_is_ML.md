---
title: Một cách dễ hiểu nhất thì Machine Learning là gì? Phân loại trong Machine Learning (Bài viết mở đầu)
date: 2023-06-24 16:30:00 +/-TTTT
categories: [machine learning]
tags: [tổng quan, basic, classification, supervised Learning, unsupervised Learning, semi-supervised Learning, reinforcement learning, regression, clustering, instance-based, bayesian]
toc: true
math: true
comments: true
published: true
